...
plt.xlim(0.5,1.5)
plt.ylim(-0.1,1.1)
plt.title("3d Constant Reconstruction, Time: %0.2f" % f1.attrs["time"], fontsize=12)
...
plt.scatter(f3["/particles"][0,:num], f3["/velocity-x"][:], facecolors='none', edgecolors='r', label="Exact")
...
plt.scatter(f3["/particles"][0,:num], f3["/pressure"][:], facecolors='none', edgecolors='r', label="Exact")
