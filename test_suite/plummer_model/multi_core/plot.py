...
for i in range(num_proc):
    ...
    if i == 0:
        ...
        final_time = h5py.File(file_final, "r").attrs["time"]

    else:
        initial_particles.append_container(io.read(file_initial))
        final_particles.append_container(io.read(file_final))
